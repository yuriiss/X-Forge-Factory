...
Тут перелічені всі моделі, якими вміє керувати X-Forge, з індикатором: зелений, коли команда є в PATH цієї машини, червоний, коли її немає. Нічого не приховується — «Grok не встановлено» корисніше за список, який мовчки його пропускає. Наведення курсора на модель показує, де знайдено її бінарний файл, — це найшвидший спосіб помітити, що консоль знайшла інший Claude, ніж той, що знаходить ваша оболонка.

Виявлення — це пошук, а не налаштування. Встановіть CLI в іншому терміналі, і рейка помітить це протягом півхвилини.
